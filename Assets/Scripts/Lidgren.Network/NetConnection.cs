...
namespace Lidgren.Network
{
	...
	public partial class NetConnection
	{
		...
		internal string m_remoteEndPoint;
		...
		/// </summary>
		public string RemoteEndPoint { get { return m_remoteEndPoint; } }
		...
		internal NetConnection(NetPeer peer, string remoteEndPoint)
		{
			m_peer = peer;
		...
		/// </summary>
		internal void MutateEndPoint(string endPoint)
		{
